...
import com.dexafree.materialList.view.OnLoadNextListener;
...
public class SwipeDismissListener implements View.OnTouchListener {
     ...
     */
    public AbsListView.OnScrollListener makeScrollListener(final OnLoadNextListener LoadNextListener) {
        return new AbsListView.OnScrollListener() {
            ...
            public void onScroll(AbsListView absListView, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                if (firstVisibleItem + visibleItemCount >= totalItemCount
                        && totalItemCount != 0 && LoadNextListener != null) {
                    LoadNextListener.onLoadNext();
                }
            }
        };
    }
